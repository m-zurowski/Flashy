...
red_button = Button(image=cross_image, highlightthickness=0, bg=BACKGROUND_COLOR, command=next_card)
red_button.grid(row=1, column=0)

check_image = PhotoImage(file="images/right.png")
green_button = Button(image=check_image, highlightthickness=0, bg=BACKGROUND_COLOR, command=is_known)
